...
3. **在时间域引入绝对对齐的多模态位置编码（[MRoPE](https://zhida.zhihu.com/search?content_id=260266360&content_type=Article&match_order=1&q=MRoPE&zhida_source=entity)）**，改善模型对事件节奏的把握；     
